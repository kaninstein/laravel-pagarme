...
/**
 * Voucher Payment Data Transfer Object
 *
 * For voucher payments (meal/food vouchers)
 * Only available for Gateway clients
 *
 * Common voucher brands in Brazil:
 * - Alelo
 * - Sodexo
 * - Ticket
 * - VR (Vale Refeição)
 */
class VoucherPaymentDTO
{
    public function __construct(
        public ?string $statementDescriptor = null,
        public VoucherCardDTO|CreditCardDTO|string|null $card = null, // VoucherCardDTO, card_id, or card_token
    ...
    public static function fromArray(array $data): self
    {
        ...
        if (isset($data['card'])) {
            $card = is_array($data['card'])
                ? VoucherCardDTO::fromArray($data['card'])
                : $data['card'];
    ...
    /**
     * Create voucher payment with card data
     */
    public static function withCard(
        VoucherCardDTO|CreditCardDTO $card,
    ...
    /**
     * Create voucher payment with card ID
     */
    ...
    /**
     * Create voucher payment with card token
     */
    ...
    /**
     * Set as payment link transaction
     */
    ...
    public function toArray(): array
    {
        ...
        // Handle card
        if ($this->card instanceof VoucherCardDTO || $this->card instanceof CreditCardDTO) {
    ...
    /**
     * Check if voucher payment data is valid
     */
